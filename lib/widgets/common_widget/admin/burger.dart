...
class Burger extends StatelessWidget { // Chuyển thành StatelessWidget
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: TitleFood(text: 'Burger - Rice - Spaghetti'),
              ),
              SizedBox(
                ...
                child: Obx(() {
                  ...
                  if (controllerTestView.products.isEmpty) {
                    ...
                    final filteredProducts = controllerTestView.products
                        .where((product) => product['Category'] == 'Burger - Cơm - Mì Ý')
                        .toList();
