...
class ComboGroup extends StatelessWidget { // Chuyển thành StatelessWidget
  const ComboGroup({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: TitleFood(text: 'Group Combo'),
              ),
              SizedBox(
                ...
                child: Obx(() {
                  ...
                  if (controllerTestView.products.isEmpty) {
                    ...
                    final filteredProducts = controllerTestView.products
                        .where((product) => product['Category'] == 'Combo Nhóm')
                        .toList();
