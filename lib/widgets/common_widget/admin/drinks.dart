...
class Drinks extends StatelessWidget { // Chuyển thành StatelessWidget
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: TitleFood(text: 'Drinks And DessertsView'),
              ),
              SizedBox(
                ...
                child: Obx(() {
                  ...
                  if (controllerTestView.products.isEmpty) {
                    ...
                    final filteredProducts = controllerTestView.products
                        .where((product) => product['Category'] == 'Thức uống & tráng miệng')
                        .toList();
