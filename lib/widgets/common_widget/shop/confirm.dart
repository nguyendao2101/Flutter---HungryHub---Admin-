...
class Confirm extends StatefulWidget {
  ...
  @override
  State<Confirm> createState() => _ConfimOrderState();
}

class _ConfimOrderState extends State<Confirm> {
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        ElevatedButton(
                                          onPressed: () async {
                                            await getDataViewModel.updateOrderStatus(order['orderId'], 'Waiting Delivery');

                                            setState(() {
                                              // Tìm và cập nhật trạng thái trong danh sách hiện tại
                                              final index = _orderTracking.indexWhere((o) => o['orderId'] == order['orderId']);
                                              if (index != -1) {
                                                _orderTracking[index]['status'] = 'Waiting Delivery';
                                              }
                                            });
                                          },
                                          ...
                                          child: Row(
                                            children: [
                                              const Text('To Waiting For Delivery'),
                                              const SizedBox(width: 12,),
                                              Image.asset(ImageAsset.delivery, height: 24,)
                                            ],
                                          ),
                                        )
