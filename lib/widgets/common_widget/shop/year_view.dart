...
class _YearViewState extends State<YearView> {
  ...
  void _filterAndCalculateRevenue() {
    ...
    _calculateRevenue(filteredOrdersCurrentYear, _yearlyRevenueCurrent, 'This Year');
    _calculateRevenue(filteredOrdersLastYear, _yearlyRevenueLast, 'Last Year');
    _calculateRevenue(filteredOrdersTwoYearsAgo, _yearlyRevenueTwoYearsAgo, 'Two Years Ago');
  }
          ...
          child: Row(
            children: [
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    _buildRevenueCard('This Year', _yearlyRevenueCurrent),
                    _buildRevenueCard('Last Year', _yearlyRevenueLast),
                    _buildRevenueCard('Two Years Ago', _yearlyRevenueTwoYearsAgo),
                  ],
                ),
              ),
              Expanded(flex: 1,child: Container()),
